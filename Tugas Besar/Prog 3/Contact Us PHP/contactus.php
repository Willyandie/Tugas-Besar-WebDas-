      ...
      <div style="text-align: center">
        ...
        <div class="column d-inline text-start">
          <form method="POST">
            ...
            <input type="text" id="fname" name="fname" placeholder="Insert Your First Name Here.." />
            <label for="lname">Last Name</label>
            <input type="text" id="lname" name="lname" placeholder="Insert Your Last Name Here.." />
...
<?php
if(isset($_POST['ok'])){
    if(empty($_POST['fname']) || empty($_POST['lname']) || empty($_POST['country']) || empty($_POST['subjects'])){
        echo "Masukkan data";
    }else{
        $fname=$_POST['fname'];
        $lname=$_POST['lname'];
        ...
        fwrite($buka,"First Name : ${fname} <br> ");
        fwrite($buka,"Last Name : ${lname} <br> ");
